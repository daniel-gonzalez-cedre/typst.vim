...
syntax match typstExprDot /\./
      \ contained
      \ nextgroup=typstExprMember

syntax match typstExprMember /\k\+/
      \ contained
      \ nextgroup=typstExprDot
...
syntax region typstExprBraces
      \ skipwhite
      \ contained
      \ contains=@typstExpr,typstExprField,typstMarkupMath
      \ nextgroup=typstExprOp,typstExprOpSym,@typstExpr
      \ start=/(/
      \ end=/)/
...
syntax match typstExprBareVar /\k\+/
      \ skipwhite
      \ contained
      \ nextgroup=typstExprDot

syntax match typstExprCommand
      \ /\v<%(let|set|show|context|import|include|as|if|else|for|while|break|continue|return)>/
      \ skipwhite skipempty
      \ contained
      \ nextgroup=@typstExpr
...
syntax match typstExprField
      \ contained
      \ nextgroup=typstExprColon
      \ /\v<\k+\ze\s*:/
...
hi def link typstExprDot Operator
hi def link typstExprMember Identifier
hi def link typstExprColon Delimiter
hi def link typstExprOp Statement
hi def link typstExprOpSym Operator
